  ...
  return (
    <PopoverPrimitive
      ...
      className={cx(
        ...
        // Cellestial DS: popovers match .card surface — rounded-md (12px),
        // ink-100 border, shadow-3 for overlay depth.
        "group/popover min-w-(--trigger-width) max-w-xs origin-(--trigger-anchor-point) rounded-md bg-surface text-ink-800 shadow-3 outline-hidden border border-ink-100 dark:border-ink-300 transition-transform [--gutter:--spacing(4)] **:[[role=dialog]]:[--gutter:--spacing(4)]",
