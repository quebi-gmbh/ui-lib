 ...
 * <FormattedNumber value={123.45} options={{ style: 'currency', currency: 'EUR' }}>
 *   {(formatted) => <span className="font-bold">{formatted}</span>}
 * </FormattedNumber>
 */
export function FormattedNumber({ value, locale, options = {}, children }: FormattedNumberProps) {
...
/**
 * Format a number as EUR currency, always with 2 decimal places.
 * Reads locale from the nearest I18nProvider automatically.
 */
