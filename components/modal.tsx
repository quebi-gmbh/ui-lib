...
const ModalContent = ({
  ...
  return (
    <ModalOverlay
      ...
      className={cx(
        // Cellestial DS backdrop — ink-900 at low opacity, subtle blur.
        "fixed start-0 top-0 z-50 h-(--visual-viewport-height,100vh) w-screen",
        "bg-ink-900/40 backdrop-blur-[1px] motion-reduce:backdrop-blur-none",
    ...
    >
      <ModalPrimitive
        ...
        className={cx(
          ...
          // DS surface with shadow-4 dialog elevation and 2xl radius (32px).
          "relative overflow-hidden bg-surface text-ink-800",
          "rounded-t-2xl sm:rounded-2xl border border-ink-100 shadow-4",
          sizes[size],
