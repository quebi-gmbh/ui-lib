...
const dropdownItemStyles = tv({
  base: [
    ...
    "group relative cursor-default select-none rounded-xs outline-0",
    // text — Cellestial body-s (14/20), ink-800.
    "text-[14px] leading-[20px] text-ink-800 forced-colors:text-[CanvasText]",
    // avatar
  ...
  variants: {
    ...
    isSelected: {
      // Selected → subtle brand fill so it reads as the chosen value.
      true: "bg-brand-50 text-brand-700 font-semibold dark:bg-primary-subtle dark:text-primary-subtle-fg [&_[data-slot='icon']:not([class*='text-'])]:text-brand-700 dark:[&_[data-slot='icon']:not([class*='text-'])]:text-primary-subtle-fg",
    },
    isFocused: {
      // Keyboard-focused → same brand-50 tint so nav and selection look unified.
      true: [
        "*:data-[slot=keyboard]:text-brand-700 dark:*:data-[slot=keyboard]:text-primary-subtle-fg [&_[data-slot='icon']:not([class*='text-'])]:text-brand-700 dark:[&_[data-slot='icon']:not([class*='text-'])]:text-primary-subtle-fg",
        "bg-brand-50 text-brand-700 dark:bg-primary-subtle dark:text-primary-subtle-fg forced-colors:bg-[Highlight] forced-colors:text-[HighlightText]",
        "*:[[slot=description]]:text-brand-700 dark:*:[[slot=description]]:text-primary-subtle-fg *:[[slot=label]]:text-brand-700 dark:*:[[slot=label]]:text-primary-subtle-fg",
      ],
    },
    isHovered: {
      true: [
