...
<ConformSwitch field={fields.notify} label="Email notifications" />`,
  ...
  enforcement: {
    ...
    // as a hand-wired field (task #194), as an error, and the only way out
    // was a `biome-ignore lint/plugin/…` at every call site. `$meta` is therefore pinned to
