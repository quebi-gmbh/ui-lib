...
export const keepFilesReadableRule: RuleMeta = {
  ...
  rationale: [
    ...
    "500 is deliberately generous. This library is 129 components and 125 of them are under it; the four that are not — sidebar, chart, and the two data tables — are composite components with many sub-parts, which is the honest case for exceeding the limit rather than a licence to. If a file needs to be longer, say so in the pull request; the warning exists to make that a decision rather than an accident.",
  ],
