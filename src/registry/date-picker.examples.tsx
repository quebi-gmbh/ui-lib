...
export const datePickerExamples: ComponentExample[] = [
  ...
  },
  {
    title: "Two digits",
    description:
      "shouldForceLeadingZeros pads the day and month segments to two digits (30.06.2026 rather than the 30.6.2026 de-DE asks for). The year is unaffected, and the calendar overlay is unchanged.",
    render: () => (
      <DatePicker
        className="max-w-xs"
        defaultValue={parseDate("2026-06-30")}
