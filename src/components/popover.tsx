 ...
 *
 * Surface tokens: bg-quebi-elevated, border-quebi-line/10, shadow-quebi-glow.
 */
  ...
  return (
    <PopoverPrimitive
      ...
      className={cn(
        ...
        "group/popover min-w-(--trigger-width) max-w-xs origin-(--trigger-anchor-point) rounded-quebi-md border border-quebi-line/10 bg-quebi-elevated text-quebi-fg shadow-quebi-glow outline-hidden transition-transform [--gutter:--spacing(4)] **:[[role=dialog]]:[--gutter:--spacing(4)]",
